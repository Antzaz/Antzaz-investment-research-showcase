(() => {
  ...
  const performanceSummary = document.createElement('script');
  performanceSummary.src = `short-term-performance.js?v=${Date.now()}`;
  performanceSummary.defer = true;
  document.head.appendChild(performanceSummary);
